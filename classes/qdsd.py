...
class QDSDLines(Dataset):
    ...
    def __init__(self, patches: List[Tuple], role: str, transform: Optional[List[Callable]] = None):
        ...
        Should be built with QDSDLines.build_split_datasets.
    ...
    def get_data(self) -> torch.Tensor:
        """
        :return: The whole patches matrix of values (no transformation apply)
        """
        return self._patches

    def get_labels(self) -> torch.Tensor:
        """
        :return: The whole patches matrix of labels (no transformation apply)
        """
    ...
    def normalize(datasets: Iterable["QDSDLines"], ref_dataset: "QDSDLines") -> None:
        ...
        # Save values to file, for consistent normalization later
